...
public class C04_TestAllShape {
	public static void main(String[] args) {
		
//		C00_Shape s = new C00_Shape();		// 1990
		// Dont have body or complete mehtod
		
		C00_Shape s = new C01_Circle();		// reference =>  parent ref = new child()
//		abstract class can not create object but can have a reference
		s.calArea();
		s.draw();
		
		
//		C05_A aa = new C05_A();		// private constructor
...
// We can't make object of Shape but make constructor of Shape resaon -> Because child class constructor can not be invoked without parent constructor - super() 
