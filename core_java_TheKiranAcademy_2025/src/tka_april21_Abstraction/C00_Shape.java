...
public abstract class C00_Shape {		// define 5 functionalities
...
//	There are two types of abstraction in java we can achieve abstraction by using one abstract class and another interface
