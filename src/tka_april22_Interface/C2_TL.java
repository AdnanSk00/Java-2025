...
// Manager class is interface having all methods as abstract and due interface we can not add any concrete method in Manager class.
// Due to absence of concrete method in Manager, TL cant extends Manager but implements that interface Manager.	
