...
//		Comparator <C4_Student>idComp = new C8_StudIdComp();
		Comparator <C4_Student>idComp = (C4_Student s1, C4_Student s2) -> {
...
//		Comparator <C4_Student>nameComp = new C9_StudNameComp();
		Comparator <C4_Student>nameComp = (C4_Student s1, C4_Student s2) -> {
...
//		Comparator <C4_Student>perComp = new C91_StudPerComp();
		Comparator <C4_Student>perComp = (C4_Student s1, C4_Student s2) -> {
